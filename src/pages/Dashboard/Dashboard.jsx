  ...
  return (
    <>
      ...
      <div className="container top-0">
        <div className="row dashboard-title">
            ...
            <div className="dashboard-card">
              <div className="p-3">
                ...
                <div className="d-flex align-items-center border-bottom border-3 ">
                  <h4>2 Hour</h4>
                  <span className="dashboard-time-tag">&#9652;2 hour</span>
                </div>
              </div>
              <div className="chart-section">
                <Doughnut
                  className="charts-width"
                  data={data}
                  plugins={plugins}
                />
              </div>
          ...
          <div className="col-md-8 p-3">
            <div className="dashboard-screen-time d-flex justify-content-between align-items-center">
              <div className="">Screening time on activity</div>
              <div className="d-flex align-items-center">
        ...
        <div className="row p-3">Most Played Game</div>
        <div className="p-3">
          <Swiper
            slidesPerView={4}
            spaceBetween={30}
