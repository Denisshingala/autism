      ...
      <div className="home-body">
        ...
        <div className="home-header2 mb-5 bg-light py-3">
          <div className="component">
            ...
            <div className="component-header h6">All Visuals</div>
            <div className="component-footer">
              Our app support fully visuals so that one can understand very
              easily.
            </div>
          </div>
          <div className="component">
            ...
            <div className="component-header h6">Audio Available</div>
            <div className="component-footer">
              Our app has feature for audio so it can be easy to hear visuals as
              well.
            </div>
          </div>
          <div className="component">
            ...
            <div className="component-header h6">Wide Range</div>
            <div className="component-footer">
              We have range of games available with us which is tested and
              proved effective.
            </div>
          </div>
          <div className="component">
            ...
            <div className="component-header h6">Trusted</div>
            <div className="component-footer">
        ...
        <div className="home-header3 mb-2">
          <div className="home-header3-container">
            <span className="my-2">
              "Children can learn anything if it's fun"
            </span>
          </div>
        </div>
